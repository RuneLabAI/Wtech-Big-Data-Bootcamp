...
| # | Oturum | Tarih | Hafta |
|---|--------|-------|-------|
| 1 | [Big Data Temelleri](week1/01-big-data-fundamentals/) | 3 Mart | Hafta 1 |
...
Proje dosyaları ve değerlendirme kriterleri için [`capstone-project/`](capstone-project/) klasörüne bakınız. Dataset ve beklentiler **12 Mart** oturumunda paylaşılmaktadır.
